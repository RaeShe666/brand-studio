	...
	return (
		<div className="login-page">
			<div className="login-image-side">
				...
				<img src="/login-bg5.jpg" alt="" className="login-bg-image" />
			</div>
			<div className="login-form-side">
				<div className="login-container">
					...
					<form className="login-form" onSubmit={submit}>
						...
						{isSignUp && <small className="form-hint">At least 6 characters</small>}
						{isSignUp && (
							<input
								type="text"
								className="login-input"
						...
						{!hasSupabaseConfig && (
							<div className="error-message">Desktop authentication configuration is missing.</div>
						)}
